...
Tog = function(p, frame, bn, i)
	...
	CloseUI.Position = UDim2.new(0.5, -330,0.2, 50)
...
function Env.new(Logo, Bind)
	...
	function Env.Tabs:Tab(title)
		...
		clicktab.MouseButton1Click:Connect(function()
			...
			for i, v in pairs(TabScolling_1:GetChildren()) do
				if v:IsA("Frame") then
		...
		function Section:Section(t, s)
			...
			function Class:Button(title, call)
				...
				UIGradient_1.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 77, 0)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 0, 0))}
			...
			function Class:Image(imageId, imageSize)
	...
	Container.Size = UDim2.new(0.95, 0, 0, 160)
	...
	ImageLabel.Position = UDim2.new(0.5, 0, 0.5, 0)
	ImageLabel.AnchorPoint = Vector2.new(0.5, 0.5)
	ImageLabel.Size = imageSize or UDim2.new(1, 0, 1, 0)
	ImageLabel.ClipsDescendants = true
	ImageLabel.Image = imageId or "rbxassetid://1234567890"
	...
	UIGradient.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 77, 0)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 0, 0))
	}
	UIGradient.Rotation = -120

	local methods = {}
	function methods:SetImage(newImageId, newSize)
		if newImageId then
	...
	return setmetatable({ frame = Container }, {
		__index = methods,
		__tostring = function() return "CustomImageObject" end
	})
end
			...
			function Class:Dropdown(info)
				...
				Desc_1.TextColor3 = Color3.fromRGB(255, 0, 0)
				Desc_1.TextSize = 11
				...
				function itemslist:AddList(text)
					...
					Line_1.BackgroundColor3 = Color3.fromRGB(255,0,0)
					Line_1.BorderColor3 = Color3.fromRGB(0,0,0)
					Line_1.BorderSizePixel = 0
